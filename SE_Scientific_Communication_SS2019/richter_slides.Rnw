...
Infectious diseases are a threat to human health \\
cost lifes and also money
...
\begin{figure}
  ...
  \includegraphics[width=0.7\textwidth,keepaspectratio]{disease-transmission_med.jpeg}
\end{figure}
...
policy evaluation (vaccine programmes, WHO disease elimination targets) \\ % HIV-AIDS, Hepatitis C
