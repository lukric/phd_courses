% \documentclass[table,notes=only]{beamer}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\note{
Good morning and welcome to my brief introduction into modelling in the world of public health.
}
...
\begin{figure}
  ...
  % https://ib.bioninja.com.au/higher-level/topic-11-animal-physiology/111-antibody-production-and/pathogenesis.html
\end{figure}

\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\note{
Charles-Edward Amory Winslow - American \textbf{bacteriologist} and \textbf{public health expert 1920} \\
\vspace{0.2cm}
responsible for loss of QUALY = quality-adjusted life year -- sick leave, treatment \\
\vspace{0.2cm}
The most severe outcome is DEATH \\
\vspace{0.2cm}
many are preventable (vaccines or other interventions) or curable \\
\vspace{0.2cm}
outbreak: is the occurrence of disease cases in excess of normal expectancy \\
\vspace{0.2cm}
endemic: infection is constantly maintained at a baseline level in a geographic area without external inputs (steady state) \\
\vspace{0.2cm}
Direct contact: Plague \\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\note{
help to prioritise interventions \\
\vspace{0.3cm}
...
%%%%%%%%%%
\begin{minipage}{.49\textwidth}
\textbf{Dynamic}, compartmental (SIR) \par % origin is in the early 20th century
\vspace{0.1cm}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\note{
Statistical: we will see an example for time series regression shortly \\
\vspace{0.3cm}
Stat models like Poisson used to calculate attack rates, risk rations, etc in Foodborne outbreaks \\
\vspace{0.3cm}
Dynamic models: origin is in the early 20th century \\
\vspace{0.3cm}
Modelling: higher influence with increasing computer power \\
\vspace{0.3cm}
Also used to predict the future (forecasts)
}
...
\vspace{0.25cm}
\textbf{Vaccine introduced} in 2012 in AT for children \par % covering 10 serotypes (PCV10), 3 doses in the first year
\end{minipage} \hfill
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\note{
Lets move on to the first example, the evaluation of an intervention on invasive pneumococcal disease \\
\vspace{0.3cm}
s. pneumoniae: bacteria \\
\vspace{0.3cm}
Serotypes: Only a small number cause severe disease like IPD \\
\vspace{0.3cm}
can result in: \textbf{meningitis, pneumonia, sepsis} \\
\vspace{0.3cm}
Risk: <2 and 50+ \\
\vspace{0.3cm}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\note{
GLM-related -- NB regression \\
\vspace{0.3cm}
2 segments \\
\vspace{0.3cm}
pre-, post-period \\
\vspace{0.3cm}
get an estimate (incl CI) for intervention effect \\
\vspace{0.3cm}
offset log(pop) to get incidence rate estimates
}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\note{
The vaccine type IPD was \textbf{reduced by} 58\% (95\% CI: 30\%; 74\%) and \textbf{67\%} (95\% CI: 32\%; 84\%) among <5 and $\ge$50 years old \\
\vspace{0.3cm}
Elderlies seem to benefit the most \\
\vspace{0.3cm}
Besides the direct effect (not shown), we also see a \textbf{herd effect}. \\
\vspace{0.3cm}
By taking action on one group, we also safe another (risk) group.
}
...
\begin{figure}
  ...
  \subcaption*{\tiny Source: Muhammad Mahdi Karim, Wikipedia}
\end{figure}
\end{minipage}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\note{
We continue with the second example -- a mathematical model of an outbreak: \\
\vspace{0.3cm}
Zika Virus is a \textbf{Vector born disease} \\
\vspace{0.3cm}
prevalent in South America, Africa, Asia \\
\vspace{0.3cm}
The WHO declared the Latin America Zika epidemic to be \textbf{Public Health Emergency of International Concern} in Feb 2016 \\
\vspace{0.3cm}
Summer Olympics: lots of worldwide travel \\
\vspace{0.3cm}
Policy suggestion/recommendation: delay pregnancy \\
\vspace{0.3cm}
To get better insight into this outbreak a mathematical model was developped
}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\note{
here: a little simplification of the model \\
\vspace{0.3cm}
stratified by age - only one layer shown
}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\note{
Write as the following system of ordinary differential equations \\
\vspace{0.3cm}
Parameters need to be estimated \\
\vspace{0.3cm}
either from \textbf{previous outbeaks, studies or data} \\
\vspace{0.3cm}
or from the outbreak itself (fit the model to current data) \\
\vspace{0.3cm}
$b$ ... biting rate \\
$\beta$ ... probability of transmission \\
$\mu$ ... mortality rate \\
$\gamma$ ... recovery rate \\
$N$ ... number of humans/vectors
}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\note{
Epidemic will re-occur when the reservoir of \textbf{susceptible} people grew big enough again \\
\vspace{0.3cm}
The outbreak ``moves'' spatially \\
\vspace{0.3cm}
intervention of mosquito control will reduce weekly infections \\
\vspace{0.3cm}
but smaller outbreaks likely to occur after \\
\vspace{0.3cm}
Also: less time between outbreaks (bc less people got infected and therefore higher amount of susceptible)
}
...
% \vspace{0.3cm}
Modelling \textbf{increasingly important} \\
\vspace{0.3cm}
Guide the highest \textbf{impact} and \textbf{cost-effective} preventions \\
\vspace{0.3cm}
\textbf{Critical tool} for public health action \\
\vspace{0.3cm}
Model limitations \\ % (as other studies)
\vspace{0.3cm}
Decision makers \textbf{benefit} - so does the population \\
\vspace{0.3cm}
\textbf{Challenges} need to be solved
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\note{
We presented two examples of applied modelling in public health \\
\vspace{0.3cm}
...
\vspace{0.3cm}
Can be a \textbf{Critical tool} for guiding public health action.
\vspace{0.3cm}
Model limitations: as other studies / models simplify the real world \\
\vspace{0.3cm}
computer power is benefitial\\
\vspace{0.3cm}
...
i wish you a nice and hot summer :) \\
...
\setbeamercolor{frametitle}{bg=structure.fg!20!bg}%
\unnumbered
\begin{frame}[fragile,noframenumbering]{Outbreaks}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\note{
Flu: 2009 not more than usual season (see also Spanish flu 1918 with 20-50 Mio deaths), but unexpectedly early, 10-15 weeks earlier then normal \\
AT: 1000 -- 4400 (2016/2017) deaths per season \\
\vspace{0.3cm}
Ebola (2015 strain): CFR up to 40--60\% \\
\vspace{0.3cm}
...
{
\unnumbered
\begin{frame}[fragile,noframenumbering]{Other Applications}
...
{
\unnumbered
\begin{frame}[fragile,noframenumbering]{Example of outbreak analytics workflow.}
\begin{center}
\begin{figure}
  \centering
